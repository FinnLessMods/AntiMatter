...
public class AntirackBlock extends AntimatterModElements.ModElement {
	@ObjectHolder("antimatter:antirack")
	public static final Block block = null;
	public AntirackBlock(AntimatterModElements instance) {
		super(instance, 2);
	}
