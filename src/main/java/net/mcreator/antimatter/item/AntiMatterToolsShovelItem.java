...
public class AntiMatterToolsShovelItem extends AntimatterModElements.ModElement {
	@ObjectHolder("antimatter:anti_matter_tools_shovel")
	public static final Item block = null;
	public AntiMatterToolsShovelItem(AntimatterModElements instance) {
		super(instance, 13);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ShovelItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("The shovel pulses with raw power..."));
			}
		...
		}.setRegistryName("anti_matter_tools_shovel"));
	}
}
