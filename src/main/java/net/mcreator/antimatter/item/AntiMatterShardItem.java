...
public class AntiMatterShardItem extends AntimatterModElements.ModElement {
	@ObjectHolder("antimatter:anti_matter_shard")
	public static final Item block = null;
	public AntiMatterShardItem(AntimatterModElements instance) {
		super(instance, 23);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("anti_matter_shard");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A shard of something powerful..."));
		}
	}
}
