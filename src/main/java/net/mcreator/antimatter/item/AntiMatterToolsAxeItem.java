...
public class AntiMatterToolsAxeItem extends AntimatterModElements.ModElement {
	@ObjectHolder("antimatter:anti_matter_tools_axe")
	public static final Item block = null;
	public AntiMatterToolsAxeItem(AntimatterModElements instance) {
		super(instance, 11);
	}
	...
	public void initElements() {
		elements.items.add(() -> new AxeItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("The axe pulses with raw power..."));
			}
		...
		}.setRegistryName("anti_matter_tools_axe"));
	}
}
